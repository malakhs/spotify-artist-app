...
import { SpotifyAuthRequest, SpotifyAuthResponse } from '../spotify-auth';
...
getToken(data: SpotifyAuthRequest){
        ...
        let credentials = 'code=' + data.code + '&grant_type=authorization_code' + '&redirect_uri=' + data.redirect_uri + '&client_id=' + sharedVariable.clientId + '&client_secret=' + sharedVariable.clientSecret;
